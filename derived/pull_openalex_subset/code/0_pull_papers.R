...
setwd("~/Documents/GitHub/hpc/derived/pull_openalex_subset/code")

id_list <- c(
  "i74775410", "i143302722", "i859038795", "i181233156", "i173911158", 
  "i173911158", "i185103710", "i20089843", "i59553526", "i138006243", 
  "i4210086901", "i94658018", "i155781252", "i12097938", "i8078737"
)
...
years <- 2010:2024   # Define the years you want to loop over
for (year in years) {
  ...
  for (inst in id_list) {
    ...
    works_temp <- oa_fetch(
      ...
      output = "list",
      topics.subfield.id = c(1908, 2206, 3103), # 1312, 1315, 1606, 1706, 
      type = "article"
    )
